...
dlt.create_streaming_table(
    ...
    comment="Raw EWD EMEA copies data ingested from Monday.com board JSON exports",
    table_properties={
        "quality": "bronze",
    ...
    expect_all_or_drop={
        "valid_send_not_empty": "send IS NOT NULL",
...
@dlt.append_flow(
    ...
    comment="Raw EWD EMEA copies data ingested from Monday.com board JSON exports flow",
)
