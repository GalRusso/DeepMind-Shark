...
dlt.create_streaming_table(
    ...
    comment="Cleaned and structured EWD EMEA trends data with enforced schema",
    ...
    expect_all_or_drop={
        ...
        "valid_trend_id_prefix": "trend_id LIKE 'EU-%' or trend_id LIKE 'EMEA-%'",
...
@dlt.append_flow(
    ...
    comment="Cleaned and structured EWD EMEA trends data with enforced schema flow",
)
