...
dlt.create_streaming_table(
    ...
    comment="Cleaned and structured EWD US trends data with enforced schema",
    ...
    expect_all_or_drop={
        ...
        # TODO: Move this to expect_all_or_fail when all the data is updated
        "valid_trend_presentation_method": "trend_presentation_method IN ('Image', 'Video', 'Narrative', 'Audio', 'Article', 'Warning', 'Website')",
        ...
        "valid_trend_id_prefix": "trend_id LIKE 'Americas-%'",
...
@dlt.append_flow(
    ...
    comment="Cleaned and structured EWD US trends data with enforced schema flow",
)
