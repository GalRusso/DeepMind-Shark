...
dlt.create_streaming_table(
    ...
    comment="Raw EWD US trends data ingested from Monday.com board JSON exports",
    table_properties={
        "quality": "bronze",
...
@dlt.append_flow(
    ...
    comment="Raw EWD US trends data ingested from Monday.com board JSON exports flow",
)
