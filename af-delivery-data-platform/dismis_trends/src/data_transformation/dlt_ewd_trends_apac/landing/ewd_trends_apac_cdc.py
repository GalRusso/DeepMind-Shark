...
dlt.create_streaming_table(
    ...
    comment="Raw EWD APAC trends data ingested from Monday.com board JSON exports",
    table_properties={
        "quality": "bronze",
    ...
    expect_all_or_drop={
        "valid_send_spreadsheet_not_empty": "send_spreadsheet IS NOT NULL",
        "valid_ongoing_items": "name != 'New item' AND name IS NOT NULL",
    }
)
...
@dlt.append_flow(
    ...
    comment="Raw EWD APAC trends data ingested from Monday.com board JSON exports flow",
)
