...
dlt.create_streaming_table(
    ...
    comment="Cleaned and structured EWD US copies data with enforced schema",
...
@dlt.append_flow(
    ...
    comment="Cleaned and structured EWD US copies data with enforced schema flow",
)
def landing_to_cleansed_cdc_flow():
    ...
    select_exprs = [
        ...
        col("ewd_trends_us")[0].alias("trend_id"),  # Updated to reference US trends
