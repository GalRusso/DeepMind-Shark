"""
EWD Trends EMEA Data Ingestion Script

This script extracts EWD Trends EMEA data from Monday.com and saves it to S3/Unity Catalog volumes.
...
def main():
    """Main entry point for EWD Trends EMEA ingestion."""

    # Parse command line arguments
    parser = argparse.ArgumentParser(description="EWD Trends EMEA Data Ingestion")
    parser.add_argument(
        "--environment",
        required=True,
        choices=["dev", "prod"],
