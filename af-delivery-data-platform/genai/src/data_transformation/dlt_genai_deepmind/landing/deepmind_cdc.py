...
dlt.create_streaming_table(
    ...
    comment="Raw Deepmind data ingested from Google Sheets CSV exports",
    table_properties={
        "quality": "bronze",
...
@dlt.append_flow(
    ...
    comment="Raw Deepmind data ingested from Google Sheets CSV exports flow",
)
def s3_to_landing_flow():
    ...
    Assumes each CSV file contains Deepmind prompt data with proper headers.
