...
dlt.create_streaming_table(
    ...
    comment="Cleansed Cohere data with standardized formats and data quality checks",
    schema=schema,
    table_properties={
        "quality": "silver",
...
@dlt.append_flow(
    ...
    comment="Cleansed Cohere data with standardized formats and data quality checks flow",
)
def landing_to_cleansed_cdc_flow():
    """
    Silver layer: Clean and standardize Cohere data from landing layer.
    ...
    return (
        ...
        .select(
            ...
            trim(col("target_type")).alias("target_type"),
