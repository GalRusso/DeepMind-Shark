...
dlt.create_streaming_table(
    ...
    comment="Raw AGI data ingested from Google Sheets CSV exports",
    table_properties={
        "quality": "bronze",
...
@dlt.append_flow(
    ...
    comment="Raw AGI data ingested from Google Sheets CSV exports flow",
)
def s3_to_landing_flow():
    ...
    Assumes each CSV file contains AGI prompt data with proper headers.
