...
dlt.create_streaming_table(
    ...
    comment="Cleansed AGI data with standardized formats and data quality checks",
    schema=schema,
    table_properties={
        "quality": "silver",
...
@dlt.append_flow(
    ...
    comment="Cleansed AGI data with standardized formats and data quality checks flow",
)
def landing_to_cleansed_cdc_flow():
    """
    Silver layer: Clean and standardize AGI data from landing layer.
    ...
    return (
        ...
        .select(
            ...
            trim(col("response_label")).alias("response_label"),
            trim(col("target_special_instructions")).alias("target_special_instructions"),
