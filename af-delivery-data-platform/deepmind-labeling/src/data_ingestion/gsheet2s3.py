...
parser.add_argument("--google_sheets_spreadsheet_id", default="1r9KtAjD9weDjCLiTgOdqru7LuJTz3GIAgJgkSo9aVgg")
parser.add_argument("--google_sheets_sheet_name", default="test_sheet")
...
REDO = False
SERVICE_ACCOUNT_DATA = json.loads(dbutils.secrets.get("pacman-keys", "google-service-account-test"))
...
def dir_path(kind: str):
    ...
    return f"/Volumes/af_delivery_{ENVIRONMENT}/data_collection/labeling/{VERTICAL}/{domain}/{SOURCE}/{now:%Y}/{now:%m}/{now:%d}"
