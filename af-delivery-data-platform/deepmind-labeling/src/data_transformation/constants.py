...
SOURCE_PATH = f"/Volumes/af_delivery_{ENVIRONMENT}/data_collection/labeling/{VERTICAL}"
...
def silver_dir_path():
    ...
    return f"/Volumes/af_delivery_{ENVIRONMENT}/data_collection/labeling/{VERTICAL}/silver/{SOURCE}/{now:%Y}/{now:%m}/{now:%d}"
