...
if __name__ == "__main__":
    ...
    spark.sql("DELETE FROM af_delivery_dev.silver_deepmind_labeling.tasks_status where task_key = 'video.audio_transcribe';")
    spark.sql("DELETE FROM af_delivery_dev.silver_deepmind_labeling.tasks_todo where task_key = 'video.audio_transcribe';")
    spark.sql("DELETE FROM af_delivery_dev.silver_deepmind_labeling.tasks_results where task_key = 'video.audio_transcribe';")
